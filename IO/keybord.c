...
static KeyNameEnum KeySym_To_Enum(KeySym key)
{
    switch(key)
    {
        case(XK_d):     return NAVE1_HOR;
        case(XK_a):     return NAVE1_ANT;
        case(XK_w):     return NAVE1_ACE;
        case(XK_s): return NAVE1_DIS;

        case(XK_Right): return NAVE2_HOR;
        case(XK_Left):  return NAVE2_ANT;
        case(XK_Up):    return NAVE2_ACE;
        case(XK_Down):     return NAVE2_DIS;
    }
